...
export const translations: Record<Locale, Dict> = {
  tr: {
    app: {
      ...
      tagline: "Hayız, nifas ve istihâze takip platformu",
    },
    nav: {
      calculator: "Hesaplama",
      history: "Geçmiş Kayıtlar",
      knowledge: "İlmihal Bilgisi",
    ...
    home: {
      title: "Hayız ve istihâze takibinde güvenilir rehber",
      subtitle:
    ...
    calculator: {
      ...
      guideBody:
        "Başlangıç ve bitiş saatlerini doğru girin. Alışılmış (sahih) hayız ve temizlik sürelerinizi son birkaç temiz döngünüze göre yazın. Maliki seçiliyse azami günü ihtiyacınıza göre ayarlayın.",
      quickIlmihal: "İlmihal",
      quickAsk: "Soru Sor",
    },
    result: {
    ...
    knowledge: {
      title: "İlmihal Bilgisi",
      subtitle: "Hayız, istihâze ve ibadet hükümlerine dair özet kartlar.",
